    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'C:/Users/BABITA/Desktop/Attend_proj/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"C:\Users\BABITA\Desktop\Attend_proj\Attendance\Manually Attendance\-------Check atttendance-------"')
...
def take_img():
    ...
    if l1 == '':
        ...
        try:
            ...
            detector = cv2.CascadeClassifier(r'C:\Users\BABITA\Desktop\Attend_proj\haarcascade_frontalface_default.xml')
            Enrollment = txt.get()
            Name = txt2.get()
            sampleNum = 0
            while (True):
            ...
            with open(r'C:/Users/BABITA/Desktop/Attend_proj/StudentDetails/StudentDetails.csv', 'a+') as csvFile:
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='grey80')
                cs = 'C:/Users/BABITA/Desktop/Attend_proj/Attendance Management System/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"C:\Users\BABITA\Desktop\Attend_proj\Attendance Management System\Attendance\-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'Sreya':
            if password == 'Sreya123':
                ...
                cs = "C:/Users/BABITA/Desktop/Attend_proj/StudentDetails/StudentDetails.csv"
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
